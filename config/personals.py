...
# Your legal name
first_name = "Shruti"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Shailendra"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Varade"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "6176068865"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Boston, MA"                  # Los Angeles, San Francisco, etc.
'''
...
gender = "Female"                 # "Male", "Female", "Other", "Decline" or ""
